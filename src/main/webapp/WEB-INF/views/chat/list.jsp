						...
						<div class="mb-2-3 pb-2-3 border-bottom">
							<div class="media mb-4 product-review">
								<div class="media-body">
									...
									<a href="/chat/detail?cno=${cvo.cno }" class="mb-1 font-weight-500 text-extra-dark-gray">${cvo.recvNickName }</a>
									</c:if>
									<c:if test="${ses.mno ne cvo.sendNick}">
									<a href="/chat/detail?cno=${cvo.cno }" class="mb-1 font-weight-500 text-extra-dark-gray">${cvo.sendNickName }</a>
									</c:if>
								</div>
