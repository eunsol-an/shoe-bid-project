							...
							<div class="col-sm-6 col-lg-3 mt-1-9">
								<div class="product-grid-four">
									...
									<c:if test="${ses ne null }">
										<a href="/product/detail?pno=${pvo.pno }&mno=${ses.mno }&pageNo=${pgn.pgvo.pageNo }&qty=${pgn.pgvo.qty}&type=${pgn.pgvo.type}&kw=${pgn.pgvo.kw}">
									...
									<c:if test="${ses eq null }">
										<h3 class="h6">
											<a href="/product/detail?pno=${pvo.pno }&mno=0&pageNo=${pgn.pgvo.pageNo }&qty=${pgn.pgvo.qty}&type=${pgn.pgvo.type}&kw=${pgn.pgvo.kw}">${pvo.pname }</a>
										</h3>
										</c:if>
										<div>
